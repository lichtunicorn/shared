...
export type publicSettableModelData<currentModelName extends modelName> = currentModelName extends "executor" ? public_settable_executor : currentModelName extends "actionButton" ? public_settable_actionButton : currentModelName extends "macro" ? public_settable_macro : currentModelName extends "variable" ? public_settable_variable : currentModelName extends "speedGroup" ? public_settable_speedGroup : currentModelName extends "scene" ? public_settable_scene : currentModelName extends "cuelist" ? public_settable_cuelist : currentModelName extends "collection" ? public_settable_collection : currentModelName extends "section" ? public_settable_section : currentModelName extends "fixture" ? public_settable_fixture : currentModelName extends "group" ? public_settable_group : currentModelName extends "preset" ? public_settable_preset : currentModelName extends "effect" ? public_settable_effect : currentModelName extends "show" ? public_settable_show : currentModelName extends "cue" ? public_settable_cue : currentModelName extends "override" ? public_settable_override : currentModelName extends "sectionSceneState" ? public_settable_sectionSceneState : currentModelName extends "sectionCuelistState" ? public_settable_sectionCuelistState : currentModelName extends "groupElement" ? public_settable_groupElement : currentModelName extends "sceneElement" ? public_settable_sceneElement : currentModelName extends "sceneElementContent" ? public_settable_sceneElementContent : currentModelName extends "cueElement" ? public_settable_cueElement : currentModelName extends "cueElementContent" ? public_settable_cueElementContent : currentModelName extends "effectElement" ? public_settable_effectElement : currentModelName extends "effectOffset" ? public_settable_effectOffset : currentModelName extends "effectKind" ? public_settable_effectKind : currentModelName extends "macroCommand" ? public_settable_macroCommand : currentModelName extends "presetElement" ? public_settable_presetElement : currentModelName extends "executorButton" ? public_settable_executorButton : currentModelName extends "executorFader" ? public_settable_executorFader : currentModelName extends "programmerElement" ? public_settable_programmerElement : currentModelName extends "programmerElementContent" ? public_settable_programmerElementContent : never;
